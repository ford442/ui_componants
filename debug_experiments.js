import { GravityWellExperiment } from '../js/gravity-well.js';
        ...
        import { HolographicText } from '../js/holographic-text.js';
        import { AerodynamicStreamExperiment } from '../js/aerodynamic-stream.js';
        import { ElasticMembraneExperiment } from '../js/elastic-membrane.js';
        import { FractalBloomExperiment } from '../js/fractal-bloom.js';
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Initialize Aerodynamic Stream
            const aerodynamicStreamContainer = document.getElementById('aerodynamic-stream-container');
            if (aerodynamicStreamContainer) {
                new AerodynamicStreamExperiment(aerodynamicStreamContainer);
            }

            // Initialize Elastic Membrane
            const elasticMembraneContainer = document.getElementById('elastic-membrane-container');
            if (elasticMembraneContainer) {
                new ElasticMembraneExperiment(elasticMembraneContainer);
            // Initialize Fractal Bloom
            const fractalBloomContainer = document.getElementById('fractal-bloom-container');
            if (fractalBloomContainer) {
                new FractalBloomExperiment(fractalBloomContainer, { numParticles: 20000 });
            }
            ...
            const holoTextContainer = document.getElementById('holographic-text-container');
            if (holoTextContainer) {
                new HolographicText(holoTextContainer, { text: 'HYBRID' });
            }
